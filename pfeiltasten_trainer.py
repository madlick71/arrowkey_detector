...
class MyCoolApp:
    ...
    def choose_next_button(self):
        ...
        self.next_button.after(50, lambda:  self.next_button.config(background=self.farbe_vorgabe))
    ...
    def press_button(self, button):
        ...
        self.button_pressed.after(100, lambda:  self.button_pressed.config(relief=tk.RAISED))
    ...
    def check_which_pressed(self):
        if self.button_pressed == self.next_button:
            ...
            self.label_stat_1.configure(text='Richtig: ' + str(self.clicks_correct))
    ...
    def uhr(self):
        while True:
            while self.sekunde <= 59 and self.minute <= 59:
                self.label_stat_uhr.configure(
                    text='Zeit: ' + str(self.minute) + ':' + str(self.sekunde))
                time.sleep(1)
